...
if choice in ['1', 'one','when']:
    try:
        ...
        msg = MIMEMultipart()
        msg['From'] = "pragati.code@gmail.com"
        ...
        if attach_choice in ["yes", "yeah"]:
            ...
            file_name = listen()
            file_path = f"C:/Users/COMPUTER/Downloads/100% voice email system for blind people/voice email system for blind people/{file_name}.pdf"
        ...
        server.starttls()
        server.login("pragati.code@gmail.com", "grqheqzoutabdfzd")
        server.sendmail("pragati.code@gmail.com", receiver_email, msg.as_string())
        server.quit()
...
elif choice in ['2', 'two', 'to','Tu']:
   # Connect to Gmail IMAP Server
    mail = imaplib.IMAP4_SSL('imap.gmail.com', 993)
    mail.login('pragati.code@gmail.com', 'grqheqzoutabdfzd')  # Use App Password
    ...
    mail_ids = total_mails[0].split()
    latest_two_emails = mail_ids[-2:] if len(mail_ids) >= 2 else mail_ids

    for num in latest_two_emails:
        ...
        for part in email_message.walk():
            if part.get_content_type() == "text/plain":
                ...
                preview_body = body[:200]  # Limit to 200 characters
