...
def recognize_speech(prompt):
    ...
    with sr.Microphone() as source:
        ...
        print(prompt)
        try:
            audio = r.listen(source, timeout=5)  # Use listen() instead of record()
            ...
            return recognize_speech(prompt)  # Retry
...
if recognize_speech("Do you want to capture your photo? Say Yes or No").lower() == 'yes' or 'yes yes' or 'say yes':
    ...
    if recognize_speech("Do you want to train your photo? Say Yes or No").lower() == 'yes' or 'yes yes' or 'say yes':
